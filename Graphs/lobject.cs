...
//        public static void Output(Graph node)
//        {
//            Console.WriteLine("============================================");
...
//        public static List<Graph> Expand(Graph iterObj)
//        {
//            List<Graph> lst = new List<Graph>();

//            // Number of cities to be traversed
//            // Города, которые нужно посетить
...
//                int[,] temparray = new int[Graph.sizeOfAll, Graph.sizeOfAll];

//                for (int i_1 = 0; i_1 < Graph.sizeOfAll; i_1++)
//                {
//                    for (int i_2 = 0; i_2 < Graph.sizeOfAll; i_2++)
//                    {
...
//                for (int j = 0; j < Graph.sizeOfAll; j++)
//                {
...
//                Graph finall = new Graph(Graph.sizeOfAll)
//                {
...
//            int[] array_to_reduce = new int[Graph.sizeOfAll];
//            int[] reduced_array = new int[Graph.sizeOfAll];

//            // Variable to store updated cost
//            int new_cost = cost;

//            // Loop for reducing rows
//            for (int i = 0; i < Graph.sizeOfAll; i++)
//            {
...
//                    for (int k = 0; k < Graph.sizeOfAll; k++)
//                    {
